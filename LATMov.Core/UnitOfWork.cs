...
namespace LATMov.Core {
    public class UnitOfWork: IDisposable {
            ...
            private GenericRepository<Director> director = null;


            public GenericRepository<Director> Director {
                get {
                    return this.director == null ? new GenericRepository<Director>(dbContext) : this.director;
                }
            }
